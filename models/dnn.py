    ...
    def train(self, pred_path=None, loss_log_path=None, csv_log_path=None, boost_round_log_path=None,
        ...
        with tf.Session(graph=train_graph) as sess:
            ...
            for x_train, y_train, w_train, e_train, x_valid, y_valid, w_valid, e_valid, valid_era \
                ...
                pred_train = self.get_prob(sess, logits, x_train, self.batch_size, inputs, keep_prob, is_training)
                pred_train_all = self.get_prob(sess, logits, self.x_train, self.batch_size, inputs, keep_prob,
                                               is_training)
                pred_valid = self.get_prob(sess, logits, x_valid, self.batch_size, inputs, keep_prob, is_training)
            ...
            prob_test_mean, pred_train_mean, loss_train_mean, loss_valid_mean, loss_train_w_mean, loss_valid_w_mean = \
                utils.calculate_means(prob_test_total, pred_train_total, loss_train_total, loss_valid_total,
            ...
            if use_global_valid:
                ...
                acc_total_global_valid = \
                    utils.print_total_global_valid_loss(prob_global_valid_mean, self.y_global_valid,
